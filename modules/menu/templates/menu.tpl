{*
	Template Smarty pour le module 'MENU'
*}
{*
								...
								<tr>
									...
									{if (isset($smarty.session.user) && $smarty.session.user->getStaff() == 1)}
										...
										{else}
											{*Connexion Staff*}
											<td>
												<a href="javascript:connecteStaff();">Con Staff
													{$idBouton="btnCoStaff"}
