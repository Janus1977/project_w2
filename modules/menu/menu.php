<?php
	...
	require_once _INCLUDES_MENU_.'fonctions.inc.php';
	...
	// A COMPLETER //
	/////////////////
	(!empty($_POST['staffSession'])) ? $_SESSION['staffSession'] = intval($_POST['staffSession']) : 0;
	$smarty->display(_TEMPLATES_MENU_.'menu.tpl');
?>