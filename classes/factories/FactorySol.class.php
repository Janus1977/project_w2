...
abstract class FactorySol {
	...
	public static function getFromTableSol($id=-1) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table sol');
		}
	...
	/*[TAG-Sol2]*/	/*[/TAG-Sol2]*/
		...
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Sol($data['id'],$data['nom'],$data['nb_cases_x'],$data['nb_cases_y'],$data['chemin']);
		
	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getFromTableSol1]*/	/*[/TAG-getFromTableSol1]*/
