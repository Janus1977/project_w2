...
abstract class FactoryArene_unites {
	...
	public static function getFromTableArene_unites($id=-1) {
		//Generated by FactoryGenerator::generateGetAllFromTable()
		$listeObjet = array();
		// Lancement de la requete
		if (empty(self::$_requete)) {
			$requete = 'SELECT * FROM `arene_unites`';
		} else {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table arene_unites');
		}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-Arene_unites2]*/	/*[/TAG-Arene_unites2]*/

		/* Traitement des donnees */
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Arene_unites($data['id'],$data['membre'],$data['type'],$data['nombre'],$data['pos_x'],$data['pos_y'],$data['image'],$data['dir_vision']);
		
	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getFromTableArene_unites1]*/	/*[/TAG-getFromTableArene_unites1]*/
