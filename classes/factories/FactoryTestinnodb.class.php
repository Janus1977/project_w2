...
abstract class FactoryTestinnodb {
	...
	public static function getFromTableTestinnodb($id=-1) {
		//Generated by FactoryGenerator::generateGetAllFromTable()
		$listeObjet = array();
		// Lancement de la requete
		if (empty(self::$_requete)) {
			$requete = 'SELECT * FROM `testinnodb`';
		} else {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table testinnodb');
		}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-Testinnodb2]*/	/*[/TAG-Testinnodb2]*/

		/* Traitement des donnees */
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Testinnodb($data['id'],$data['id2']);
		
	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getFromTableTestinnodb1]*/	/*[/TAG-getFromTableTestinnodb1]*/
