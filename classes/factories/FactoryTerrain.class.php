...
abstract class FactoryTerrain {
	...
	public static function getFromTableTerrain($id=-1) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table terrain');
		}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-Terrain2]*/	/*[/TAG-Terrain2]*/

		/* Traitement des donnees */
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Terrain($data['id'],$data['nom'],$data['description'],$data['image']);
		
	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getFromTableTerrain1]*/	/*[/TAG-getFromTableTerrain1]*/
