...
abstract class FactoryGroupe {
	...
	public static function getFromTableGroupe($id=-1) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table groupe');
		}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-Groupe2]*/	/*[/TAG-Groupe2]*/

		/* Traitement des donnees */
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Groupe($data['id'],$data['nom'],$data['valeur']);
		
	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getFromTableGroupe1]*/	/*[/TAG-getFromTableGroupe1]*/
