...
abstract class FactoryCategorie {
	...
	public static function getFromTableCategorie($id=-1) {
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-Categorie2]*/	/*[/TAG-Categorie2]*/

		/* Traitement des donnees */
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Categorie($data['id'],$data['nom'],$data['description'],$data['type']);
		
	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getFromTableCategorie1]*/	/*[/TAG-getFromTableCategorie1]*/
