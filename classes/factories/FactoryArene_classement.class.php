...
abstract class FactoryArene_classement {
	...
	public static function getFromTableArene_classement($id=-1) {
		//Generated by FactoryGenerator::generateGetAllFromTable()
		$listeObjet = array();
		// Lancement de la requete
		if (empty(self::$_requete)) {
			$requete = 'SELECT * FROM `arene_classement`';
		} else {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table arene_classement');
		}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-Arene_classement2]*/	/*[/TAG-Arene_classement2]*/

		/* Traitement des donnees */
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Arene_classement($data['id'],$data['membre'],$data['points'],$data['place_precedente']);
		
	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getFromTableArene_classement1]*/	/*[/TAG-getFromTableArene_classement1]*/
