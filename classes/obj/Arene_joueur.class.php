...
class Arene_joueur extends Arene {
	...
	public function __construct($id=0,$membre=0,$heure_connexion=0,$heure_der_con=0) {
		...
		$this->_id = $id;
		$this->_membre = $membre;
		$this->_heure_connexion = $heure_connexion;
		$this->_heure_der_con = $heure_der_con;
	...
	public function setHeure_connexion($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setHeure_connexion1]*/	/*[/TAG-setHeure_connexion1]*/

		$this->_heure_connexion = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setHeure_connexion2]*/	/*[/TAG-setHeure_connexion2]*/

	}



	public function setHeure_der_con($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setHeure_der_con1]*/	/*[/TAG-setHeure_der_con1]*/

		$this->_heure_der_con = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setHeure_der_con2]*/	/*[/TAG-setHeure_der_con2]*/
	...
	public function getHeure_connexion() {
		//Generated by ObjectGenerator::generateGet()
		return $this->_heure_connexion;
	}



	public function getHeure_der_con() {
		//Generated by ObjectGenerator::generateGet()
		return $this->_heure_der_con;
	}
	...
	public function __toString() {
		...
		$chaine .= 'Le champ heure_connexion vaut '.$this->getHeure_connexion().'<br/>';
		$chaine .= 'Le champ heure_der_con vaut '.$this->getHeure_der_con().'<br/>';
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO arene_joueur (id,membre,heure_connexion,heure_der_con)';
			$requete .= ' VALUES ';
			$requete .= '(';
			$requete .= '\'\','; //valeur forcee pour l'insertion
			$requete .= $this->getMembre().',';
			$requete .= $this->getHeure_connexion().',';
			$requete .= $this->getHeure_der_con().',';
	...
	public function update() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			$requete = 'UPDATE arene_joueur SET ';
			$requete .= 'membre = '.$this->getMembre().',';
			$requete .= 'heure_connexion = '.$this->getHeure_connexion().',';
			$requete .= 'heure_der_con = '.$this->getHeure_der_con().',';
			$requete = substr($requete,0,strlen($requete)-1);
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM arene_joueur WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$membre,$heure_connexion,$heure_der_con);');
	}
	...
	public function compareTo($object) {
		...
		if ($object instanceof Arene_joueur) {
			...
			if ($this->_heure_connexion != $object->getHeure_connexion()) {
				$data['heure_connexion'] = $object->getHeure_connexion();
			}
			if ($this->_heure_der_con != $object->getHeure_der_con()) {
				$data['heure_der_con'] = $object->getHeure_der_con();
			}
		}
		return $data;
	}
	...
	public function affiche() {
		...
		$smarty->assign('arene_joueur',$this);
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Arene_joueur.tpl');
	}
