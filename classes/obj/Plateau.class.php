...
class Plateau {
	...
	protected $_nb_cases_x; /* int(10) */
	protected $_nb_cases_y; /* int(10) */
	...
	public function __construct($id=0,$nom='',$description='',$chemin='',$nb_cases_x=0,$nb_cases_y=0) {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO plateau (id,nom,description,chemin,nb_cases_x,nb_cases_y)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM plateau WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$description,$chemin,$nb_cases_x,$nb_cases_y);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Plateau.tpl');
	}
