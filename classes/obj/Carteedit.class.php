...
class Carteedit {
	...
	public function __construct($id=0,$nom='',$nb_cases_x=0,$nb_cases_y=0) {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO carteedit (id,nom,nb_cases_x,nb_cases_y)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM carteedit WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$nb_cases_x,$nb_cases_y);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Carteedit.tpl');
	}
