...
class Connectes {
	...
	protected $_membre; /* bigint(20) */
	/* liste des objets Membre */
	protected $_oMembre; /* membre Object*/

	protected $_date_connexion; /* datetime */
	...
	public function __construct($id=0,$membre=0,$date_connexion='') {
		//Generated by ObjectGenerator::generateConstruct()
		$this->_id = $id;
		$this->_membre = $membre;
		$this->_date_connexion = $date_connexion;
	...
	public function setDate_connexion($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setDate_connexion1]*/	/*[/TAG-setDate_connexion1]*/

		$this->_date_connexion = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setDate_connexion2]*/	/*[/TAG-setDate_connexion2]*/
	...
	public function __toString() {
		...
		$chaine .= 'Le champ date_connexion vaut '.$this->getDate_connexion().'<br/>';
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO connectes (id,membre,date_connexion)';
			$requete .= ' VALUES ';
			$requete .= '(';
			$requete .= '\'\','; //valeur forcee pour l'insertion
			$requete .= $this->getMembre().',';
			$laDate = $this->getDate_connexion();
			if (strlen($laDate) > 0) {
				$requete .= '\''.$laDate.'\',';
			} else {
				$requete .= 'NOW(),';
	...
	public function update() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			$requete = 'UPDATE connectes SET ';
			$requete .= 'membre = '.$this->getMembre().',';
			$laDate = $this->getDate_connexion();
			if (strlen($laDate) > 0) {
				$requete .= 'date_connexion = \''.$laDate.'\',';
			} else {
				$requete .= 'date_connexion = NOW(),';
			}
			$requete = substr($requete,0,strlen($requete)-1);
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM connectes WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$membre,$date_connexion);');
	}
	...
	public function compareTo($object) {
		...
		if ($object instanceof Connectes) {
			...
			if ($this->_date_connexion != $object->getDate_connexion()) {
				$data['date_connexion'] = $object->getDate_connexion();
			}
		}
		return $data;
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Connectes.tpl');
	}
