...
class Boussole {
	protected $_id; /* tinyint(2) unsigned */
	protected $_orientation; /* varchar(5) */
	...
	public function __construct($id=0,$orientation='') {
	...
	public function setOrientation($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setOrientation1]*/	/*[/TAG-setOrientation1]*/

		$this->_orientation = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setOrientation2]*/	/*[/TAG-setOrientation2]*/
	...
	public function __toString() {
		...
		$chaine .= 'Le champ orientation vaut '.$this->getOrientation().'<br/>';
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO boussole (id,orientation)';
			$requete .= ' VALUES ';
			$requete .= '(';
			$requete .= '\'\','; //valeur forcee pour l'insertion
			$requete .= '\''.$this->getOrientation().'\',';
	...
	public function update() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			$requete = 'UPDATE boussole SET ';
			$requete .= 'orientation = \''.$this->getOrientation().'\',';
			$requete = substr($requete,0,strlen($requete)-1);
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM boussole WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$orientation);');
	}
	...
	public function compareTo($object) {
		...
		if ($object instanceof Boussole) {
			...
			if ($this->_orientation != $object->getOrientation()) {
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Boussole.tpl');
	}
