...
class Terrain {
	...
	protected $_description; /* varchar(250) */
	protected $_image; /* varchar(50) */
	...
	public function __construct($id=0,$nom='',$description='',$image='') {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO terrain (id,nom,description,image)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM terrain WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$description,$image);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Terrain.tpl');
	}
