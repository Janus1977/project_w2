...
class Alliance {
	...
	public function __construct($id=0,$nom='',$tag='',$description='') {
	...
	public function setTag($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setTag1]*/	/*[/TAG-setTag1]*/

		$this->_tag = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setTag2]*/	/*[/TAG-setTag2]*/
	...
	public function __toString() {
		...
		$chaine .= 'Le champ tag vaut '.$this->getTag().'<br/>';
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO alliance (id,nom,tag,description)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function update() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			$requete = 'UPDATE alliance SET ';
			$requete .= 'nom = \''.$this->getNom().'\',';
			$requete .= 'tag = \''.$this->getTag().'\',';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM alliance WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$tag,$description);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Alliance.tpl');
	}
