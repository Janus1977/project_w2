...
class Camp {
	...
	protected $_attaque; /* varchar(3) */
	protected $_sauvegarde; /* varchar(3) */
	protected $_initiative; /* varchar(3) */
	protected $_toucher; /* varchar(3) */
	protected $_pdv; /* text */
	...
	public function __construct($id=0,$nom='',$description='',$attaque='',$sauvegarde='',$initiative='',$toucher='',$pdv='') {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO camp (id,nom,description,attaque,sauvegarde,initiative,toucher,pdv)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM camp WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$description,$attaque,$sauvegarde,$initiative,$toucher,$pdv);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Camp.tpl');
	}
