...
class Privilege {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO privilege (id,nom,description)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM privilege WHERE id = '.$this->getId();
		}
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Privilege.tpl');
	}
