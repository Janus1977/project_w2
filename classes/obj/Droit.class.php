...
class Droit {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO droit (id,nom,valeur)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM droit WHERE id = '.$this->getId();
		}
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Droit.tpl');
	}
