...
class Armees {
	...
	/* identifiant composite Idmembre */
	protected $_idmembre; /* bigint(20) unsigned */
	/* liste des objets Idmembre */
	protected $_oIdmembre; /* idmembre Object*/
	...
	public function __construct($id=0,$nom='',$description='',$idmembre=0,$points=0,$date_creation='',$date_modification='') {
	...
	public function setIdmembre($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setIdmembre1]*/	/*[/TAG-setIdmembre1]*/

		/* un identifiant est toujours un entier non nul */
		if (!intval($nouvelleValeur) || $nouvelleValeur < 0) {
			return false;
		}
		$this->_idmembre = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setIdmembre2]*/	/*[/TAG-setIdmembre2]*/
	...
	public function __toString() {
		...
		if (!empty($this->_idmembre)) {
			$chaine .= '<br/>Membre associ&eacute;: '.$this->_idmembre.'<br/>';
		} else {
			$chaine .= 'Pas de Membre associ&eacute;<br/>';
		}
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO armees (id,nom,description,idmembre,points,date_creation,date_modification)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM armees WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$description,$idmembre,$points,$date_creation,$date_modification);');
	}
	...
	public function compareTo($object) {
		...
		if ($object instanceof Armees) {
			...
			if ($this->_idmembre != $object->getIdmembre()) {
				$data['idmembre'] = $object->getIdmembre();
			}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Armees.tpl');
	}
