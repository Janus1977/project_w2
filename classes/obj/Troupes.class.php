...
class Troupes {
	...
	public function __construct($id=0,$nom='',$description='',$idmembre=0,$date_creation='',$date_modification='') {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO troupes (id,nom,description,idmembre,date_creation,date_modification)';
			$requete .= ' VALUES ';
			$requete .= '(';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM troupes WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$description,$idmembre,$date_creation,$date_modification);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Troupes.tpl');
	}
