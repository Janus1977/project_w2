...
class Commentaires {
	...
	/* identifiant composite News */
	protected $_news; /* bigint(20) */
	/* liste des objets News */
	protected $_oNews; /* news Object*/
	...
	public function __construct($id=0,$news=0,$membre=0,$contenu='',$publication='',$modification='',$valide=0) {
	...
	public function setNews($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	...
	/*[TAG-setNews1]*/	/*[/TAG-setNews1]*/
		...
		$this->_news = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setNews2]*/	/*[/TAG-setNews2]*/

	}

	protected function setNewsObject() {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setNewsObject1]*/	/*[/TAG-setNewsObject1]*/

		if ($this->_news > 0) {
			$this->_oNews = FactoryNews::getFromTableNews($this->_news);
		}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setNewsObject2]*/	/*[/TAG-setNewsObject2]*/
	...
	public function getNewsObject() {
		//Generated by ObjectGenerator::generateGet()
		if (empty($this->_oNews)) {
			$this->setNewsObject();
		}
		if ((empty($this->_oNews) || is_null($this->_oNews))&& $this->_news > 0) {
			$this->setNewsObject();
		}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-getNewsObject1]*/	/*[/TAG-getNewsObject1]*/
	...
	public function __toString() {
		...
		$chaine .= 'Le champ news vaut '.$this->getNews().'<br/>';
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO commentaires (id,news,membre,contenu,publication,modification,valide)';
			$requete .= ' VALUES ';
			$requete .= '(';
			$requete .= '\'\','; //valeur forcee pour l'insertion
			$requete .= $this->getNews().',';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM commentaires WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$news,$membre,$contenu,$publication,$modification,$valide);');
	}
	...
	public function compareTo($object) {
		...
		if ($object instanceof Commentaires) {
			...
			if ($this->_news != $object->getNews()) {
				$data['news'] = $object->getNews();
			}
	...
	public function affiche() {
		...
		$smarty->assign('commentaires',$this);
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Commentaires.tpl');
	}
