...
class Dimension {
	...
	protected $_largeur; /* bigint(20) unsigned */
	protected $_longueur; /* bigint(20) unsigned */
	protected $_surface; /* bigint(20) unsigned */
	...
	public function __construct($id=0,$nom='',$type=0,$largeur=0,$longueur=0,$surface=0) {
	...
	public function setLargeur($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setLargeur1]*/	/*[/TAG-setLargeur1]*/

		$this->_largeur = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setLargeur2]*/	/*[/TAG-setLargeur2]*/

	}



	public function setLongueur($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setLongueur1]*/	/*[/TAG-setLongueur1]*/

		$this->_longueur = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setLongueur2]*/	/*[/TAG-setLongueur2]*/

	}



	public function setSurface($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet()
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setSurface1]*/	/*[/TAG-setSurface1]*/

		$this->_surface = $nouvelleValeur;

	/*
	 * Entre ces deux balises vous pourrez mettre votre code specifique a la classe.
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-setSurface2]*/	/*[/TAG-setSurface2]*/
	...
	public function __toString() {
		...
		$chaine .= 'Le champ largeur vaut '.$this->getLargeur().'<br/>';
		$chaine .= 'Le champ longueur vaut '.$this->getLongueur().'<br/>';
		$chaine .= 'Le champ surface vaut '.$this->getSurface().'<br/>';
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO dimension (id,nom,type,largeur,longueur,surface)';
			$requete .= ' VALUES ';
			$requete .= '(';
			$requete .= '\'\','; //valeur forcee pour l'insertion
			$requete .= '\''.$this->getNom().'\',';
			$requete .= $this->getType().',';
			$requete .= $this->getLargeur().',';
			$requete .= $this->getLongueur().',';
			$requete .= $this->getSurface().',';
	...
	public function update() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			$requete = 'UPDATE dimension SET ';
			$requete .= 'nom = \''.$this->getNom().'\',';
			$requete .= 'type = '.$this->getType().',';
			$requete .= 'largeur = '.$this->getLargeur().',';
			$requete .= 'longueur = '.$this->getLongueur().',';
			$requete .= 'surface = '.$this->getSurface().',';
			$requete = substr($requete,0,strlen($requete)-1);
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM dimension WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent()
		return ('parent::__construct($id,$nom,$type,$largeur,$longueur,$surface);');
	}
	...
	public function compareTo($object) {
		...
		if ($object instanceof Dimension) {
			...
			if ($this->_largeur != $object->getLargeur()) {
				$data['largeur'] = $object->getLargeur();
			}
			if ($this->_longueur != $object->getLongueur()) {
				$data['longueur'] = $object->getLongueur();
			}
			if ($this->_surface != $object->getSurface()) {
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Dimension.tpl');
	}
	 ...
	 * Il sera preserve lors de la reconstruction automatique.
	 */
	/*[TAG-Dimension21]*/	/*[/TAG-Dimension21]*/
