...
class ManagerInventaire {
	/** Instance de la classe (managerInventaire) */
	private static $_instance = null;

	/** Connexion a la base de donnees (database) */
	private static $_oConnexion = null;

	/** Liste des objet de la classe (Inventaire) */
	private static $_aListeInventaire = array();
	...
	public function getById($value=-1) {
		...
		return FactoryInventaire::getFromTableInventaire($value);
	}

	public function getByJoueurId($value) {
		//Generated by ManagerGenerator::generateGetByJoueurId()
		return FactoryInventaire::getFromExtTableJoueur($value);
	}
	...
	public function getFromExtTableMembre($idmembre=-1) {
		...
		return FactoryInventaire::getFromExtTableMembre($idmembre);
	}

	public function deleteCompositeLinksFromMembre($idmembre) {
		//Generated by ManagerGenerator::generateDeleteCompositeLinks()
		$requete = 'DELETE FROM inventaire WHERE membre = '.$idmembre;
	}

	public function getFromExtTableUnite($idunite=-1) {
		//Generated by ManagerGenerator::generateGetFromTableFromFK()
		/* Appel de la methode de la Fabrique */
		return FactoryInventaire::getFromExtTableUnite($idunite);
	}

	public function deleteCompositeLinksFromUnite($idunite) {
		//Generated by ManagerGenerator::generateDeleteCompositeLinks()
		$requete = 'DELETE FROM inventaire WHERE unite = '.$idunite;
	}

	public function getFromExtTableEquipement($idequipement=-1) {
		//Generated by ManagerGenerator::generateGetFromTableFromFK()
		/* Appel de la methode de la Fabrique */
		return FactoryInventaire::getFromExtTableEquipement($idequipement);
	}

	public function deleteCompositeLinksFromEquipement($idequipement) {
		//Generated by ManagerGenerator::generateDeleteCompositeLinks()
		$requete = 'DELETE FROM inventaire WHERE equipement = '.$idequipement;
	}

	public function getFromExtTableUnite_joueur($idunite_joueur=-1) {
		//Generated by ManagerGenerator::generateGetFromTableFromFK()
		/* Appel de la methode de la Fabrique */
		return FactoryInventaire::getFromExtTableUnite_joueur($idunite_joueur);
	}

	public function deleteCompositeLinksFromUnite_joueur($idunite_joueur) {
		//Generated by ManagerGenerator::generateDeleteCompositeLinks()
		$requete = 'DELETE FROM inventaire WHERE unite_joueur = '.$idunite_joueur;
	}

	public function getFromExtTableEquipement_joueur($idequipement_joueur=-1) {
		//Generated by ManagerGenerator::generateGetFromTableFromFK()
		/* Appel de la methode de la Fabrique */
		return FactoryInventaire::getFromExtTableEquipement_joueur($idequipement_joueur);
	}

	public function deleteCompositeLinksFromEquipement_joueur($idequipement_joueur) {
		//Generated by ManagerGenerator::generateDeleteCompositeLinks()
		$requete = 'DELETE FROM inventaire WHERE equipement_joueur = '.$idequipement_joueur;
	}
	...
	public function delete($object=array()) {
		...
		if (! $object instanceof Inventaire) {
			$oInventaire = new Inventaire($object['id'],$object['membre'],$object['unite'],$object['equipement'],$object['unite_joueur'],$object['equipement_joueur']);
		} else {
			$oInventaire = $object;
		}
		...
		if (database::getInstance()->executeRequete($oInventaire->delete())) {
			/* Requete OK */
			return true;
		} else {
			/* Requete NOK lancement d'une exception PDO */
			throw new PDOException('Erreur sur delete (Inventaire)');
		}
	}
	...
	public function update($object=array()) {
		...
		if (!empty($_SESSION['inventaire']) && sizeof($_SESSION['inventaire']->compareTo($oInventaire)) > 0) {
			$_SESSION['inventaire'] = $oInventaire;
		}
		/* on update car les objets sont different */
		return database::getInstance()->executeRequete($oInventaire->update());
	}
	...
	public function save($object=array()) {
		...
		return database::getInstance()->executeRequete($oInventaire->save());
	}

	public function findBy($champ,$data='') {
		//Generated by ManagerGenerator::generateFindBy()
		/* creation d'un objet de base de la classe */
		$object = new Inventaire();
		$resultat = array();
		for ($i = 0; $i < sizeof($this -> _aListeInventaire); $i++) {
			$object = $this -> _aListeInventaire[$i];
		...
		if (sizeof($resultat) > 0) {
			...
			//n'existe pas
			return "Pas de Inventaire de ".strtolower($champ)." '".$data."'";
		}
	}

	public function getInventaireVide() {
	...
	public function getFromMembreId($idmembre) {
		return FactoryInventaire::getFromMembreId($idmembre);
	}
	/*[/TAG-Inventaire21]*/
